...
.then((data) => {
    ...
    correct.addEventListener("click", () => {
        if (almost.style.backgroundColor === "orange" || wrong.style.backgroundColor === 'red') {
    ...
    wrong.addEventListener("click", () => {
        if (correct.style.backgroundColor === "green" || almost.style.backgroundColor === "orange") {
    ...
    almost.addEventListener("click", () => {
        if (correct.style.backgroundColor === "green" || wrong.style.backgroundColor === "red") {
            almost.style.backgroundColor = "white"
        } else {
